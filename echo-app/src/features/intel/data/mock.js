...
// true = отдавать моки локально; false = ходить в /intel/* (живой бэкенд intel-домена).
// Моки остаются как fallback/демо и для разработки без бэкенда.
export const INTEL_USE_MOCK = false;
