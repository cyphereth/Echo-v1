...
export function Icon({ name, size = 18, stroke = 2, color, style, className }) {
  const base = { width: size, height: size, color, flexShrink: 0, ...(style || {}) };
  if (FILL_ICONS[name]) {
    return (
      <svg viewBox="0 0 24 24" fill="currentColor" className={className} style={base}
